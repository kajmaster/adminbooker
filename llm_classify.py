...
def _bouw_prompt(ledgers, omschrijving, leverancier, voorbeelden):
    ...
    return (
        ...
        "UIT DE LIJST hieronder. Kies altijd de MEEST SPECIFIEKE passende rekening; "
        ...
        "Richtlijnen voor het kiezen van de kostencategorie:\n"
        "- Terugkerende/vaste lasten gaan vóór: woorden als 'maandelijks', "
        "'monthly', 'per maand', 'jaarlijks', 'abonnement', 'subscription', "
        "'licentie', 'hosting', of een maandelijkse/periodieke retainer wijzen op "
        "vaste lasten — kies dan een abonnementen-/vaste-lastenrekening (bv. "
        "'Abonnementen') als die in de lijst staat, ook als het anders als advies "
        "zou tellen.\n"
        "- Marketing/reclame: SEO, content, advertenties, campagnes, "
        "leadgeneratie en lead-pipeline werk, social media, drukwerk, "
        "websitepromotie. Boek dit als marketing, NIET als advies.\n"
        "- Automatisering/software/IT: software, hosting, licenties, "
        "abonnementen, API's, integraties, koppelingen, dashboards, "
        "data-/dataverrijkingsdiensten, AI- en workflow-inrichting.\n"
        "- Advies/consultancy: ALLEEN echt strategisch of adviserend werk "
        "(strategie-retainer, consultancy, interim-advies). Niet voor "
        "uitgevoerde marketing- of IT-diensten.\n"
        "- Opleiding: training, cursus, workshop, seminar, certificering.\n"
        "- Werk door derden/uitbesteed: door een derde uitgevoerde "
        "(bouw)werkzaamheden of inhuur.\n"
        "Reserveer advies/consultancy dus voor adviserend werk, en boek "
        "geleverde diensten op hun eigen specifieke rekening.\n\n"
